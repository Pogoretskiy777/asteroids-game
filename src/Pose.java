...
public class Pose extends Point {
    ...
    /**
     * Return a new Pose that is a copy of this pose with provided x-coordinate. (Since the Pose class is immutable,
    ...
    /**
     * Return a new Pose that is a copy of this pose with provided y-coordinate. (Since the Pose class is immutable,
     * this provides a convenient alternative to a setter method.)
     * 
    ...
    /**
     * Return a new Pose that is a copy of this pose with provided heading. (Since the Pose class is immutable, this
     * provides a convenient alternative to a setter method.)
     * 
    ...
    public Pose move(Vector2D vector) {
        return new Pose(getX() + vector.getX(), getY() + vector.getY(), heading);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Pose other = (Pose) obj;
        return xPosition == other.xPosition && yPosition == other.yPosition && heading == other.heading;
    }

    @Override
    public String toString() {
        return "Pose[xPosition=" + xPosition + ", yPosition=" + yPosition + ", heading=" + heading + "]";
    }
