/**
 * Class representing a two-dimensional vector. This class provides methods for interacting with a vector as x and y
 * components *or* as a heading (direction) and magnitude (length).
 * 
 * A heading of 0 represents a vector pointing directly to the right, the heading increases as vectors are rotated in a
...
public class Vector2D {
     ...
     * 
     * A heading of 0 represents a vector pointing directly to the right, the heading increases as vectors are rotated
    ...
    public Vector2D(double heading, double magnitude) {
        if (magnitude < 0) {
            throw new IllegalArgumentException("Vector magnitude cannot be less than 0.");
        }
    ...
    /**
     * Returns a newly created Vector2D object created from the provided (x, y) values.
     * 
    ...
    /**
     * Return a new Vector that is a copy of this vector with provided magnitude. (Since the Vector class is immutable,
     * this provides a convenient alternative to a setter method.)
     * 
    ...
    /**
     * Return a new Vector that is a copy of this vector with provided heading. (Since the Vector class is immutable,
     * this provides a convenient alternative to a setter method.)
     * 
    ...
    public Vector2D add(Vector2D other) {
        return Vector2D.fromXY(xComponent + other.xComponent, yComponent + other.yComponent);
    }
